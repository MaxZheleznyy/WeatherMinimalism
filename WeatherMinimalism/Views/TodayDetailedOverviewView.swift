...
class TodayDetailedOverviewView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let contentConstraints = [
            ...
            todayDetailedOverviewMainStackView.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 8),
            todayDetailedOverviewMainStackView.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -8),
